...
#$TYPO3_CONF_VARS['SC_OPTIONS']['tce']['formevals']['tx_restructure_redirect_recursivecheck'] =
#	'EXT:restructure_redirect/class.tx_restructure_redirect_recursivecheck.php';
